...
tokenizer = StableDiffusionPipeline.from_pretrained('runwayml/stable-diffusion-v1-5').tokenizer
...
class LocalBlend:
    ...
    def __init__(self, prompts: List[str], words: [List[List[str]]], threshold=.3): # type: ignore
